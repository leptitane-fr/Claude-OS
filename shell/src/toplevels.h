...
/* Demande la fermeture d'une fenetre.
 *
 * Une DEMANDE, pas un ordre : l'application peut ouvrir une boite « voulez-
 * vous enregistrer ». C'est le comportement voulu -- un dock qui tue les
 * fenetres ferait perdre du travail. */
void shell_toplevel_close (const ShellWindow *win);
